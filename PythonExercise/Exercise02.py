...
if choiceint==1:
    ...
    if number1==0 and number2==0:
        ...
        print("DDM is a very brilliant software developer(。^_^ 。)")
    elif number1==0 and number2!=0:
        print(numberint1,"is a even number")
        print("DDM is a very handsome software developer(。^_^ 。)")
    elif number1==1:
        print(numberint1,"is a odd number")
        print("DDM is a software developer who always keeps his word(。^_^ 。)")
elif choiceint==2:
    ...
    if number3==0:
        ...
        print("DDM is a very happy software developer(。^_^ 。)")
    else:
        print(numberstr2,"is not a multiple of",numberstr3)
        print("DDM is a very smart software developer(。^_^ 。)")
else:
